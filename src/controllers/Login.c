...
int main(int argc, char *argv[])
{
    ...
    decrypted_id[sizeof(decrypted_id) - 1] = '\0';
    strncpy(decrypted_password, encrypted_password, sizeof(decrypted_password)-1);
    decrypted_password[sizeof(decrypted_password) - 1] = '\0';
